...
%\footnote{This is essentially the proof system from Sect. \ref{sec:matr-bits} for $m=1$. {\color{red} Deber\'ia ir ac\'a esto? o basta con referenciar la sec no binding?}}
