...
For witness samplable distributions, we define a stronger notion of soundness where the adversary has also access to a witness of the parameter $\rho$ \cite{EPRINT:GonHevRaf15}.
\begin{description}
