...
\subsection{The Scheme}
    \input{bits/matr-bits-scheme}
\fi
\subsection{Security Proof}

\begin{proof}
{\bf Completeness.}
Follows from the fact that $([\vecb{c}]_1,[\ovc]_1)\in\Lang_{\sfcom,[\pdsum{\matr{G}}{n}]_1,[\ovG]_1,mn}$ and that $[\ovc]_1\in\Lang_{[\ovG]_1,\sfbits}$.
