...
\chapter{Other Contributions} \label{sec:extras}
    ...
    \section{Ring Signature of Size $\Theta(\sqrt[3]{n})$ without Random O\-ra\-cles} \label{sec:opt-rs}

        \input{sections/extras/ring-signature}

    \section{Improved aZKSMP}

        \input{sections/extras/improved-aZKSMP}
